...
7.  ***Proportion type***: Upon selecting *Proportion* in ***Mediation proportion or estimate***, this checkbox option will show up, providing two choices *PM*(Proportion Mediated) and *APM*(Adjusted Proportion Mediated): $$PM=\frac{IE}{IE+DE}$$ and $$APM=\frac{IE}{|IE|+|DE|}\cdot\frac{|IE+DE|}{IE+DE}=\frac{IE}{IE+DE}\cdot\frac{|IE+DE|}{|IE|+|DE|}$$
...
Through heatmaps, (1) the exposures' correlations with components/modules, (2) the outcomes' associations with components/modules and (3) mediation estimates and proportion mediated for each component/module and exposure-outcome pair, as well as their significance levels can be visualized.
