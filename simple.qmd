...
Once you have uploaded these datasets, you can view the correlation coefficients in Step 2 and the risk estimates in Step 3. To refresh the visualizations and see the updated plots, simply click on the ***Refresh Plot*** button.
This will allow you to analyze the relationships between your exposures, outcomes, and covariates effectively.
