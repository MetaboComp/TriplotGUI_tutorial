...
Run `TriplotGUI_shiny_tryout` to open your interface. What we will show as an example in the interface here correspond to the [code example steps](simple_code.qmd#step-1){target="_blank"}
