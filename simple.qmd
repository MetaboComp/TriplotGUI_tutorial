...
First upload the Omics data in step 1 in the interface and then examine the scree plot, score plot, loadings plot and biplot at step 1. ![](img/simple_1.png)
...
Then upload exposures, outcomes and covariates data in step 2 in the interface.

![](img/simple_2.png)

You could see the correlation coefficients and risk estimates at step 2 respectively in visualizations by clicking "Refresh plot".

![](img/simple_2_1.png)

## Step 3: Visualization of Triplot

In step 3 in the interface, by clicking "Refresh plot", you can view and download the triplot that co-visualizes the three plots shown above. The left side panel gives you freedom of making adjustment to the plot. ![](img/simple_3.png)
...
Users can then check the heatmaps of correlations, risk estimations and mediation results at step 5 in the interface. By removing other PCs in the "Visualization settings", users may only show results relevant to PC1 and PC2.
