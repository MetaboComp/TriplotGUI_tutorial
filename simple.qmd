...
Run `TriplotGUI_shiny_tryout` to open your interface. What we will show as an example in the interface here correspond to the [code example steps](https://yingxiaoyan.gitlab.io/triplotgui_tutorial/simple_code.html#step-1){target="_blank"}
